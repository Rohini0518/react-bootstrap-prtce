...
//    task-2.Convert seconds into HH:MM:SS format.
 ...
 const [timer,setTimer]=useState(secondsToTime(10))
  ...
  return (<div>
    <h1>{now.format()}</h1>
    <h2>{"seconds-"}{end.diff(start,"seconds")}</h2>
    <h2>{"minutes-"}{end.diff(start,"minutes")}</h2>
    <h2>{"Hours-"}{end.diff(start,"hours")}</h2>   {/* task-1.Learn how to find the number of hours difference between two dates. */}
